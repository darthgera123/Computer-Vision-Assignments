...
def algo_grabcut(filename,outfile,foreground=[],background=[],pos1x=1,pos1y=1,pos2x=511,pos2y=511,times=5, algo=True):
	...
	if algo:
		...
		mask2[mask==3] = 1		
		GrabCut(filename,outfile,mask2, gamma=50)
	return True
